...
export class SignalController {
  ...
  create(@Body('userId') userId: number, @Body() createSignalDto: CreateSignalDto) {
  ...
  @ApiBody({ 
    schema: {
      type: 'object',
      properties: {
        userId: { type: 'number', description: 'ID of the user selecting the signal' }
      }
    }
  })
  @ApiResponse({ 
  ...
  acceptSignal(@Param('id', ParseIntPipe) id: number, @Body('userId') userId: number) {
  ...
  @ApiBody({ 
    schema: {
      type: 'object',
      properties: {
        userId: { type: 'number', description: 'ID of the user canceling the signal' }
      }
    }
  })
  @ApiResponse({ 
  ...
  cancelSignal(@Param('id', ParseIntPipe) id: number, @Body('userId') userId: number) {
  ...
  @ApiBody({ 
    schema: {
      type: 'object',
      properties: {
        userId: { type: 'number', description: 'ID of the user completing the signal' }
      }
    }
  })
  @ApiResponse({ 
